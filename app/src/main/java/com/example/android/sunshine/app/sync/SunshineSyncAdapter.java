...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public static final int SYNC_FLEXTIME = 60;
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .build();
//            Log.i(TAG, "onPerformSync: "+ builtUri.toString());
...
//            Log.i(TAG, "onPerformSync: "+ urlConnection.getResponseMessage());
            // Read the input stream into a String
            InputStream inputStream = urlConnection.getInputStream();
            StringBuffer buffer = new StringBuffer();
            if (inputStream == null) {
                Log.i(TAG, "onPerformSync: null input stream");
                // Nothing to do.
                return;
            }
//            Log.i(TAG, "onPerformSync: "+ String.valueOf(inputStream));
...
//            Log.i(TAG, "onPerformSync: "+ forecastJsonStr);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            Log.i(TAG, "Sync Complete. " + cVVector.size() + " Inserted");
        ...
        Context context = getContext();
                ...
                if (cursor.moveToFirst()) {
                    ...
                    try {
                        ...
                        mGoogleApiClientStatic = new GoogleApiClient.Builder(context)
                                ...
                                .addApi(Wearable.API)
                                .build();
                        mGoogleApiClientStatic.connect();
                        ...
                        PendingResult<DataApi.DataItemResult> pendingResult =
                                Wearable.DataApi.putDataItem(mGoogleApiClientStatic, putDataReq);
                        pendingResult.setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                            @Override
                            public void onResult(final DataApi.DataItemResult result) {
                                if(result.getStatus().isSuccess()) {
                                    Log.i(TAG, "In sync adapter: Data item set: " + result.getDataItem().getUri());
                                    mGoogleApiClientStatic.disconnect();
                                }
                            }
                        });
                    }
    ...
    public static Account getSyncAccount(Context context) {
         ...
         */
             ...
             * here.
             */
            Log.i(TAG, "getSyncAccount: did not exist");
            onAccountCreated(newAccount, context);
        }
        else
        {
//            Log.i(TAG, "getSyncAccount: existed");
